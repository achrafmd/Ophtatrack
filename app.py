# app.py — OphtaDossier (version mobile “native” avec barre d’onglets)
# -------------------------------------------------------------------
...
section.main > div { padding-top: .5rem !important; padding-bottom: 5.5rem !important; } /* place pour la navbar */
...
.consult-card{ composes: card; } /* (indication) */
